...
## Two places to check auth
1. dispatch checkAuth action in componentWillMount() and componentWillReceiveProps().
2. `redux-auth-wrapper` has been used as private routes.
